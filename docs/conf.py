...
"""
completion documentation build configuration file.
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'A library for tracking completion of blocks by learners in edX courses.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'completion'),
                os.path.join(root_path, 'completion/migrations')])
